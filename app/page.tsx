...
export default function Home() {
  ...
  <div className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-24 lg:py-32">
    <div className="mx-auto mb-12 w-full max-w-3xl text-center md:mb-16 lg:mb-20">
      <h1 className="mb-4 text-4xl font-semibold md:text-5xl">The Website You Want Without The <span className="bg-[url('https://assets.website-files.com/63904f663019b0d8edf8d57c/6390526ac2a607693620c97b_Rectangle%2010.svg')] bg-cover bg-center px-4 text-white">Dev Time</span>.</h1>
  ...
  <img src="https://assets.website-files.com/63904f663019b0d8edf8d57c/63905b9f809b5c8180ce30c5_pattern-1.svg" alt="" className="img absolute top-16 left-0 right-auto bottom-auto -z-10 w-24 sm:w-32 md:bottom-1/2 md:left-0 md:right-auto md:top-auto" />
  <img src="https://assets.website-files.com/63904f663019b0d8edf8d57c/63905ba1538296b3f50a905e_pattern-2.svg" alt="" className="img absolute bottom-auto left-auto right-0 top-0 -z-10 hidden sm:inline-block" />
</section>
<section>
<div className="pt-5 bg-gray-100 dark:bg-gray-900" id="pricing" data-theme="light">
  <div className="mx-auto pb-20 mt-4 max-w-7xl px-6 lg:px-8">
    <div className="mx-auto max-w-4xl text-center">
      <h1 className="autoshot text-base font-semibold leading-7 text-indigo-600 dark:text-indigo-400">Pricing</h1>
    ...
    <div className="autoshot ring-1 ring-gray-300 dark:ring-white/10 rounded-3xl p-8 xl:p-10">
      ...
      <div className="autoshot bg-white/5 ring-2 ring-indigo-700 rounded-3xl p-8 xl:p-10 shadow-indigo-700 shadow-2xl">

...
const Footer = () => {
    return (
      <>
      <footer className="w-full py-5 bg-neutral-900">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="max-w-2xl mx-auto">
                  <a href="/" className="flex justify-center ">
                  </a>
                      <ul className="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-5 mb-10 border-b border-gray-200">
                      ...
                      <div className="flex space-x-10 justify-center items-center mb-6">
                          ...
                          <a href=""  className="block  text-white transition-all duration-500 hover:text-indigo-600 mt-2">
                          <i className="fa-brands fa-linkedin text-white hover:text-indigo-600 text-2xl"></i>
                                  
                          </a>
                          <a href="https://github.com/aakashsaini09/ToolsHub"  className="block  text-white transition-all duration-500 hover:text-indigo-600 mt-2">
